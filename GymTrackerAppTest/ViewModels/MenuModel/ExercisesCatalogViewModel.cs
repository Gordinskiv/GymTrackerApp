            ...
            new MuscleGroupItem
            {
                ...
                Exercises = new ObservableCollection<ExerciseItem>
                {
                    new ExerciseItem { Name = "Жим лежачи", TargetMuscle = "Chest", SecondaryTargetMuscle = "Triceps", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/BenchPress.jpeg"
                    },
                    new ExerciseItem
                    {
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/BenchPress45.jpeg"
                    },
                    new ExerciseItem { Name = "Віджимання на брусах", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/Dips.jpeg" },
                }
            },
            new MuscleGroupItem
            {
                ...
                Exercises = new ObservableCollection<ExerciseItem>
                {
                    new ExerciseItem { Name = "Вертикальна тяга", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/VerticalThrust.jpeg" },
                    new ExerciseItem { Name = "Горизонтальна тяга", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/SeatedRow.jpeg" },
                    new ExerciseItem { Name = "Підтягування", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/Pullups.jpeg" }
                }
            },
            new MuscleGroupItem
            {
                ...
                Exercises = new ObservableCollection<ExerciseItem>
                {
                    new ExerciseItem { Name = "Присід зі штангою", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/Squat.jpeg" },
                    new ExerciseItem { Name = "Випади", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/Lunges.jpeg" },
                    new ExerciseItem { Name = "Жим ногами", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/LegPress.jpeg" },
                    new ExerciseItem { Name = "Піднімання на носки", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/CalfRaises.jpeg" },
                    new ExerciseItem 
                    { 
                        Name = "Станова тяга", 
                        ...
                        ImagePath = "avares://GymTrackerAppTest/Assets/Deadlift.jpeg"
                    },
                    new ExerciseItem 
                    { 
                    ...
                    ImagePath = "avares://GymTrackerAppTest/Assets/Bulgarian.jpeg" 
                    }
                }
            }
        };
