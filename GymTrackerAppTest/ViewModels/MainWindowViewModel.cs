...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    /// <summary>
    /// Перемикає тему застосунку (світла/темна).
    /// </summary>
    [RelayCommand]
    private void ToggleTheme()
    {
        ...
        {
            Avalonia.Application.Current.RequestedThemeVariant = IsDarkTheme ? Avalonia.Styling.ThemeVariant.Dark : Avalonia.Styling.ThemeVariant.Light;
        }
    }
}
